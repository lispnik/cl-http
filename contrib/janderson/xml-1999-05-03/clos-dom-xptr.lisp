...
(defMethod dom-element
  ...
  (with-xptr-strings ((name "root().child(1,LIS-DOM:NAME)")) datum
    (dom (|html|::A '|html|::HREF (format nil "~s?NAME=~a" (xml-datum.type  datum) (or name "NONAME")))
...
(defMethod dom-element
  ...
  (with-xptr-elements ((LISP-DOM:type #!>root().child(1,LISP-DOM:TYPE))) datum
    (with-xptr-strings ((LISP-DOM:name #!>root().child(1,LISP-DOM:NAME))
                        (LISP-DOM:documentation #!>root().child(1,LISP-DOM:DOCUMENTATION))
                        (LISP-DOM:initform #!>root().child(1,LISP-DOM:INITFORM))
                        (LISP-DOM:initarg #!>root().child(1,LISP-DOM:INITARG)))
                       datum
      (with-xptrs ((LISP-DOM:reader #!>root().child(1,LISP-DOM:reader) list)
                   (LISP-DOM:writer #!>root().child(1,LISP-DOM:writer) list)
                   (LISP-DOM:accessor #!>root().child(1,LISP-DOM:accessor) list))
                  datum
        (dom |html|::TR
             ...
             (dom |html|::TD (if LISP-DOM:documentation
                               (make-instance 'xmlp::serialized-data :content LISP-DOM:documentation)
                               ""))
             (dom |html|::TD
  ...
  (let-elements-content (LISP-DOM::name) datum
    (dom* |html|::DD
          (when-elements (LISP-DOM::documentation) datum
            (make-instance 'xmlp::serialized-data
              :content (element.content LISP-DOM::documentation))))))
...
(defMethod dom-element
  ...
  (with-xptrs ((name "origin().child(1,LIS-DOM:NAME)" string)
               (documentation "origin().child(1,LISP-DOM:documentation" string)
               (arglist "origin().child(1,LIS-DOM:ARGLIST)" list)
               (methods "origin().child(all,cl-types:method)" element))
              datum
     (dom |html|::HTML
          (dom |html|::HEAD (dom-element datum '|html|::TITLE))
          (dom |html|::BODY
...
(xmlp::pprint (dom-element (dom-element #'view-size :dom) :html))
(xmlp::pprint (dom-element (dom-element (dom function (dom name "test")) '|html|::a) :html))
(xmlp::pprint (dom-element (dom function (dom name "test")) '|html|::a))
(inspect (dom-element (dom function (dom name "test")) '|html|::a))
(inspect (dom function (dom name "test")))
(find-symbol 
