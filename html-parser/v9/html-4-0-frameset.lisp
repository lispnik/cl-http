...
;;; Last edited by smishra on Wed Sep  2 16:33:38 1998
...
;;; Can't handle the SGML definition in my framework
;;; Directly modifying NOFRAMES element
...
(define-html-element frameset		; window subdivision
    :content (:and (+ (:or frameset frame)) (? noframes))
    :attributes (%coreattrs		; id, class, style, title
...
(define-html-element frame		; subwindow
    :end-optional t
    :attributes (%coreattrs		; id, class, style, title
