...
;;; File: defs.lisp
;;; Last edited by smishra on Thu Oct 22 17:19:39 1998
...
(defun print-parser (parser stream ignore)
  ...
  (print-unreadable-object
   ...
   (let ((print-string (if (> (length (parser-input parser)) 10)
			   (concatenate 'string (subseq (parser-input parser) 0 10) "...")
			   (parser-input parser))))
     (format stream "~S ~D/~D"
	     print-string (parser-read-position parser) (length (parser-input parser))))))
