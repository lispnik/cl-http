...
;;; File: html-4-0-strict.lisp
;;; Last edited by smishra on Wed Jul 29 14:00:58 1998
...
(define-html-entity %block
    (:or p %heading %list %preformatted dl div
	 noscript blockquote form hr
...
(define-html-entity %pre.exclusion
    (:or img object big small sub sup))
...
(define-html-element address
    :content (* %inline)	; information on author
    :attributes (%attrs			; %coreattrs, %i18n, %events
		 ))
...
(define-html-element BUTTON		; push button
    :content (* %flow)
    :exclusions (:or A %formctrl FORM FIELDSET)
    :attributes (%attrs			; %coreattrs, %i18n, %events
		 (name CDATA :implied)
