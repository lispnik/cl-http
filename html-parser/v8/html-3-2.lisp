...
;;; File: html-3-2.lisp
;;; Last edited by smishra on Wed Jul 30 23:22:01 1997
...
(define-html-element div
    :content %body.content
    :default-container body
    :attributes ((align (left center right) left)))
...
(define-html-element hr
    :end-optional t
    :default-container body
    :attributes ((align (left right center) :implied)
...
(define-html-element caption
    :content (* %text)
    :attributes ((align (top bottom) :implied)))
