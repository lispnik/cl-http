...
(defmethod foreign-port ((http-stream socket::af-internet))
  (socket:remote-port http-stream))

(defmethod local-port ((http-stream socket::af-internet))
  (socket:local-port http-stream))

(defmethod foreign-host ((http-stream socket::af-internet))
