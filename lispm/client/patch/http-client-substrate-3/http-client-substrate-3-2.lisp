...
;;; Patch file for HTTP-CLIENT-SUBSTRATE version 3.2
;;; Reason: Function (CLOS:METHOD URL:NAME-STRING (HTTP::CLIENT)):  new.
;;; Written by JCMa, 11/18/99 22:06:08
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:CLIENT;CLIENT.LISP.225")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:CLIENT;CLIENT.LISP.225")
