;;; -*- Mode: LISP; Syntax: ansi-common-lisp; Package: USER; Base: 10; Patch-File: T -*-
;;; Patch file for LAMBDA-IR version 22.3
;;; Reason: Function (CLOS:METHOD LR::DOCUMENT-MASK-FROM-LOGICAL-SEARCH (LR:DOCUMENT-CONTEXT LR::SEARCH-CONSTRAINT T)):  new bit-vector oriented text search.
;;; Written by JCMa, 9/24/1999 03:08:33
;;; while running on Publications Y2K Testbed from HOST6:/usr/lib/symbolics/eop-pub6-no-subs-19990923.vlod
...
;;; Binary Tree 34.0, Working LispM Mailer 8.0, HTTP Server 70.12,
;;; W3 Presentation System 8.0, CL-HTTP Server Interface 53.0,
;;; Experimental Symbolics Common Lisp Compatibility 4.0, Comlink Packages 6.0,
;;; Comlink Utilities 10.0, COMLINK Cryptography 2.0, Routing Taxonomy 9.0,
;;; COMLINK Database 11.21, Email Servers 12.0, Comlink Customized LispM Mailer 7.0,
;;; Dynamic Forms 14.4, Communications Linker Server 39.7,
;;; Lambda Information Retrieval System 22.2, Comlink Documentation Utilities 6.0,
;;; White House Publication System 25.28, WH Automatic Categorization System 15.14,
;;; 8-5-Genera-Local-Patches 1.41, 39-COMLINK-Local-Patches 1.14,
;;; Publications-Server-Local-Patches 1.5, Ivory Revision 5, VLM Debugger 329,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:LAMBDA-IR;CONSTRAINTS.LISP.13")

;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:LAMBDA-IR;CONSTRAINTS.LISP.13")
