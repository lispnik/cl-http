...
;;; Patch file for CL-HTTP version 70.9
;;; Reason: Function HTTP::PRINT-COMMA-SEPARATED-HEADER-PLIST:  parallel to print-comma-separated-header.
;;; Written by JCMa, 9/20/1999 21:24:57
...
;;; Binary Tree 34.0, Working LispM Mailer 8.0, Experimental HTTP Server 70.8,
...
;;; Experimental White House Publication System 25.24,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;HEADERS.LISP.432")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HEADERS.LISP.432")
