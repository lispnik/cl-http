...
;;; Patch file for CL-HTTP version 70.11
;;; Reason: Slay resignalling bug that can occur within REPORT-STATUS.
;;; 
;;; Function (CLOS:METHOD HTTP::REPORT-STATUS (HTTP::REPORTABLE-CONDITION T) :AROUND):  don't talk to client stream if dead alrteady.
;;; Remove function (CLOS:METHOD HTTP::REPORT-STATUS (SYS:NETWORK-ERROR T) :AROUND): undefine.
;;; Variable HTTP::*REPORT-STATUS-CONDITION*:  holds current report-status condition.
;;; Function (CLOS:METHOD HTTP::REPORT-STATUS (HTTP::HTTP-CONDITION T) :AROUND):  fix rentrant report error.
;;; Written by JCMa, 9/22/1999 17:47:28
...
;;; Binary Tree 34.0, Working LispM Mailer 8.0, Experimental HTTP Server 70.10,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;REPORT.LISP.172"
  "HTTP:SERVER;REPORT.LISP.174")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;REPORT.LISP.172")
(SCT:PATCH-SECTION-ATTRIBUTES
  "-*- Mode: LISP; Syntax: ANSI-Common-Lisp; Package: http; Base: 10; Default-character-style: (:fix :roman :normal) -*-")

(SCL:FUNDEFINE '(METHOD REPORT-STATUS (NETWORK-ERROR T) :AROUND))
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;REPORT.LISP.174")
(SCT:PATCH-SECTION-ATTRIBUTES
  "-*- Mode: LISP; Syntax: ANSI-Common-Lisp; Package: http; Base: 10; Default-character-style: (:fix :roman :normal) -*-")
