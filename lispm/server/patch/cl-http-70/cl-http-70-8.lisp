...
;;; Patch file for CL-HTTP version 70.8
;;; Reason: Variable HTTP::*HEADER-FILL-COLUMN*:  new variable.
;;; Function HTTP::PRINT-COMMA-SEPARATED-HEADER:  add fill-column arg defaulting to *header-fill-column*.
;;; Written by JCMa, 9/19/1999 23:02:32
;;; while running on Publications Server from HOST1:/usr/lib/symbolics/eop-world-pub1-host1-990919.vlod
...
;;; Experimental COMLINK Database 11.15, Experimental Email Servers 12.0,
;;; Experimental Comlink Customized LispM Mailer 7.0,
;;; Experimental Dynamic Forms 14.3, Experimental Communications Linker Server 39.4,
;;; Experimental Lambda Information Retrieval System 22.2,
;;; Experimental Comlink Documentation Utilities 6.0,
;;; Experimental White House Publication System 25.21,
;;; Experimental WH Automatic Categorization System 15.10,
;;; 8-5-Genera-Local-Patches 1.41, 39-COMLINK-Local-Patches 1.11,
;;; Publications-Server-Local-Patches 1.4, Ivory Revision 5, VLM Debugger 329,
;;; Genera program 8.16, DEC OSF/1 V4.0 (Rev. 205),
;;; 1260x932 24-bit TRUE-COLOR X Screen HOST1:0.0 with 224 Genera fonts (DECWINDOWS Digital Equipment Corporation Digital UNIX V4.0 R1),
;;; Machine serial number 1703019217,
...
(SCT:FILES-PATCHED-IN-THIS-PATCH-FILE 
  "HTTP:SERVER;VARIABLES.LISP.176"
  "HTTP:SERVER;HEADERS.LISP.431")


;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;VARIABLES.LISP.176")
...
;========================
(SCT:BEGIN-PATCH-SECTION)
(SCT:PATCH-SECTION-SOURCE-FILE "HTTP:SERVER;HEADERS.LISP.431")
(SCT:PATCH-SECTION-ATTRIBUTES
